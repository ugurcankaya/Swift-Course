...
var Ugur = Developer(name: "Ugur", jobTitle: "Junior", yearsExp: 15)
Ugur.age = 25
var Sean = Ugur

Sean.name = "Sean" //reference of Ugur's changed because it's a reference type

Ugur.explainDev() // prints Sean
